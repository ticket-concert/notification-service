...
func (_m *TokenGenerator) JWTAuthorization(request *http.Request) (*helpers.PayloadJWT, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*http.Request) (*helpers.PayloadJWT, error)); ok {
		return rf(request)
	}
	if rf, ok := ret.Get(0).(func(*http.Request) *helpers.PayloadJWT); ok {
		r0 = rf(request)
	} else {
		if ret.Get(0) != nil {
