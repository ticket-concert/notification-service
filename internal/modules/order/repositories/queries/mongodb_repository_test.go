...
import (
	...
	mongoRQ "notification-service/internal/modules/order/repositories/queries"
	"notification-service/internal/pkg/helpers"
	mocks "notification-service/mocks/pkg/databases/mongodb"
...
type CommandTestSuite struct {
	...
	repository  order.MongodbRepositoryQuery
	ctx         context.Context
}
...
func (suite *CommandTestSuite) TestFindOneUserId() {
	...
	// Act
	result := suite.repository.FindOrderById(suite.ctx, "1")
	// Asset
